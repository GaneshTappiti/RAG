...
Description: Generates optimized Lovable.dev prompts using RAG retrieval
"""
...
class LovablePromptGenerator:
    """Main prompt generator for Lovable.dev"""
    
    def __init__(self, config_path: str = "lovable.yaml", chroma_path: str = "chroma_lovable"):
    ...
    def _create_vector_store(self):
        """Create vector store from Lovable docs"""
        ...
        print(f"Created vector store with {len(chunks)} document chunks")
