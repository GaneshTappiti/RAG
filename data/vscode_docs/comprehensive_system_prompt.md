# Vscode - Comprehensive System Prompt Guide

This document contains the complete system prompts and documentation for Vscode, extracted from the comprehensive AI tools repository.
