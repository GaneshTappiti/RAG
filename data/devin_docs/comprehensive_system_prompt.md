# Devin - Comprehensive System Prompt Guide

This document contains the complete system prompts and documentation for Devin, extracted from the comprehensive AI tools repository.
